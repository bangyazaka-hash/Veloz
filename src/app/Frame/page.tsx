...
export default function Frame() {
  const [data, setData] = useState<FrameItem[]>([]);
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
              <div className="max-w-2xl">
                ...
                <h1 className="text-white text-2xl sm:text-4xl font-extrabold mt-1">
                  Frame Collection
                </h1>
                <p className="text-white/90 mt-3 leading-relaxed">
                  Cari frame yang pas untuk performa, kenyamanan, dan gaya.
                </p>
        ...
        <section className="w-full">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-8">
              <div>
                <h2 className="text-xl sm:text-2xl font-bold">Semua Frame</h2>
            ...
            {!loading && data.length === 0 && (
              <div className="mt-10 rounded-2xl border bg-white p-8 text-center">
                <p className="font-semibold">Belum ada produk frame.</p>
