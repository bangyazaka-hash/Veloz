...
export default function TambahComponentPage() {
  ...
  async function handleSubmit(e: any) {
    ...
    if (res.ok) {
      alert("Wheel berhasil ditambahkan!");
      window.location.href = "/Admin/wheel";
    } else {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-white p-4">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-lg">
        ...
        <h1 className="text-3xl font-bold text-center mb-8">Tambah Wheel</h1>

        <form onSubmit={handleSubmit} className="flex flex-col gap-6">

          <input
            type="text"
            placeholder="Judul Wheel"
            value={judul}
