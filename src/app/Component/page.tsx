            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
              <div className="max-w-2xl">
                ...
                <p className="text-white/90 mt-3 leading-relaxed">
                  Pilih komponen original untuk performa yang lebih mantap.
                </p>
        ...
        <section className="w-full">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 mb-8">
              <div>
                <h2 className="text-xl sm:text-2xl font-bold">Semua Component</h2>
            ...
            {!loading && data.length === 0 && (
              <div className="mt-10 rounded-2xl border bg-white p-8 text-center">
                <p className="font-semibold">Belum ada produk component.</p>
